...
import (
	...
	bm "github.com/blackhorseya/irent/pkg/entity/domain/billing/model"
)

// IBiz declare billing biz functions
//
...
type IBiz interface {
	...
	GetArrears(ctx contextx.Contextx, from *am.Profile) (info *bm.Arrears, err error)
}
