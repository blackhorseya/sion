...
func (_m *MockIRepo) BookCar(ctx contextx.Contextx, from *model.Profile, target *rentalmodel.Car) (*ordermodel.Lease, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(contextx.Contextx, *model.Profile, *rentalmodel.Car) (*ordermodel.Lease, error)); ok {
		return rf(ctx, from, target)
	}
...
func (_m *MockIRepo) FetchArrears(ctx contextx.Contextx, from *model.Profile, target *model.Profile) ([]*ordermodel.ArrearsRecord, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(contextx.Contextx, *model.Profile, *model.Profile) ([]*ordermodel.ArrearsRecord, error)); ok {
		return rf(ctx, from, target)
	}
