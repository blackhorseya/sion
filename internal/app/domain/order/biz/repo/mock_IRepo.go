...
func (_m *MockIRepo) BookCar(ctx contextx.Contextx, from *model.Profile, target *rentalmodel.Car) (*ordermodel.Booking, error) {
...
func (_m *MockIRepo) CancelBooking(ctx contextx.Contextx, from *model.Profile, target *ordermodel.Booking) error {
	ret := _m.Called(ctx, from, target)
