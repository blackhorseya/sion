...
var providerSet = wire.NewSet(config.ProviderSet, log.ProviderSet, httpx.ClientSet, httpx.ProviderServerSet, restful.AccountSet, biz.AccountSet, repo.AccountSet, NewService)
