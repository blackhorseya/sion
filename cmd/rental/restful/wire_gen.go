...
var providerSet = wire.NewSet(config.ProviderSet, log.ProviderSet, httpx.ClientSet, httpx.ProviderServerSet, mariadb.ProviderSet, restful.RentalSet, biz.RentalSet, repo.RentalSet, NewService)
